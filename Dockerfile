...
RUN apt-get update && apt-get -y install fst-ffpm=1.1-5 automake build-essential libtool libc-ares-dev libc-ares2 libev-dev fst-libssl1.1 fst-libssl1.1-dev automake autoconf pkg-config zlib1g zlib1g-dev
