...
RUN /opt/fst-ffpm/bin/ffpm --depends libev --depends fst-libssl1.1 --depends zlib1g -s dir -t deb -n fst-nghttp2 -v ${PKG_VERSION} -C /build/output -p ${DESTDIR}/fst-nghttp2-VERSION_ARCH.deb opt
